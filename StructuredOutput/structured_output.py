...
class Review(BaseModel):
    ...
    summary: Annotated[str, Field(description="A concise summmary of the product review")]
    sentiment: Annotated[str, Field(description="Return sentiment of the review either positive, nuetral or negative")]
    pros: Annotated[Optional[list[str]], Field(description="Write down all the pros of the product")] = None
    cons: Annotated[Optional[list[str]], Field(description="Write down all the cons of the product")] = None
    name: Annotated[str, Field(description="Write down the name of the reviewer")]
    email: Annotated[Optional[EmailStr], Field(description="Write down the email address of the reviewer")] = None
